...
class SidemenuVC: UIViewController {
    ...
    //var arrTblList = ["Feedback","Share","Privacy Policy","T&C","Help & Support","Rate","Aboutus"]
    var arrImg = ["fedback" , "share" , "terms", "privacy","help","rate","aboutus"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0{
            ...
            if let link = NSURL(string: "https://www.apple.com") {
                    let objectsToShare = ["CalorieMate", link] as [Any]
